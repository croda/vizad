...
if __name__ == "__main__":
    ...
    training_data_1, training_data_2 = split_list(trainingData)

    
    t1=buildtree(training_data_1)
    t2=buildtree(training_data_2)
    
    c1 = classify(testCase,t1)
    c2 = classify(testCase,t2)
